...
### Modelo 1 – Casos diarios de COVID-19 y muertes en Europa
...
```{r}
par(mfrow=c(1,2))
barplot(df_europe$cases,ylab = "Casos", col = "blue", main="Casos positivos por COVID-19", ylim = c(0,20000))
#dev.new()
barplot(df_europe$deaths, ylab = "Muertes", ylim = c(0, 20000), col="blue", main="Muertes por COVID-19")
```
...
# Relación casos de muerte entre continentes.

```{r}
continentes=factor(df$continentExp)
plot(continentes, ylim =c(0, 20000), ylab = "Muertes por COVID-19", sub = "Relación de muertes por COVID-19 por continentes", col = "blue")
```
Se observa que la incidencia de muertes ha sido mayor en Europa que en el resto de continentes.
